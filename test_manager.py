...
class TestChessManager(unittest.TestCase):
    ...
    def test_move_with_turn_token(self):
        ...
        first_turn_token, white_username, actual_turn_color = self.manager.challenge_accepted(board_id)
        # initial board turn should be WHITE
        self.assertEqual(actual_turn_color, WHITE)
        # move WHITE with token
        second_turn_token, black_username, actual_turn_color = self.manager.move_with_turn_token(first_turn_token, 12, 3, 11, 3)
        ...
        third_turn_token, white_username, actual_turn_color = self.manager.move_with_turn_token(second_turn_token, 3, 3, 4, 3)
